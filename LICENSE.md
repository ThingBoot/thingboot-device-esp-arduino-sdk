...
Third-party components — including but not limited to the ESP8266 Arduino Core, arduino-esp32, cJSON, ArduinoHttpClient, and PubSubClient — are governed by their own open-source licenses (LGPL, Apache-2.0, MIT, GPL-3.0, etc.). These licenses are independent of the commercial terms above.
